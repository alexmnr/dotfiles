...
local widget = wibox.widget {
	...
	image = os.getenv("HOME") .. "/.config/awesome/theme/icons/arrow-right.png",
	resize = true,
	opacity = 1,
}
...
tray_toggle:connect_signal("button::press", function(_, _, _, button)
	if button == 1 then
		...
		if systray.visible then
			widget:set_image
			(os.getenv("HOME") .. "/.config/awesome/theme/icons/arrow-right.png")
		else
			widget:set_image
			(os.getenv("HOME") .. "/.config/awesome/theme/icons/arrow-left.png")
		end
	end
end)
